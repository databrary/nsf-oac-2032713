...
```{r, fig.cap="Summary of country data from shared Databrary volumes; source: https://databrary.github.io/analytics/participant-demographics.html#country"}
...
```{r, fig.cap = "Most common tags and keywords across shared Databrary volumes; source: https://databrary.github.io/analytics/tags-and-keywords.html", out.width="75%"}
