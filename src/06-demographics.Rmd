...
Data summarized here reflect the state of the Databrary system on 2023-08-01.
...
```{r, fig.cap="Illustrative spreadsheet from https://databrary.org/volume/8"}
...
Indeed, the [`databraryr` package](databraryr-r-package.html) makes use of this feature, as does the [analytics pipeline](https://databrary.github.io/analytics/).
...
When creating a new dataset/volume, the user is prompted to design a spreadsheet that is specific to the needs of their study.
The following figure shows one of the "help" images associated w

```{r, fig.cap="Participant-level variables supported by Databrary's spreadsheet"}
...
```{r, fig.cap="Histogram of age data from shared Databrary volumes; source:  https://databrary.github.io/analytics/participant-demographics.html#age", out.width="70%"}
...
```{r, fig.cap="Summary of race data from shared Databrary volumes; source: https://databrary.github.io/analytics/participant-demographics.html#n-participants-1"}
...
```{r, fig.cap="Summary of ethnicity data from shared Databrary volumes; source: https://databrary.github.io/analytics/participant-demographics.html#n-participants-2"}
...
```{r, fig.cap="Summary of pregnancy term data from shared Databrary volumes; source: https://databrary.github.io/analytics/participant-demographics.html#n-participants-4"}
...
```{r, fig.cap="Summary of birth weight data from shared Databrary volumes; source: https://databrary.github.io/analytics/include/img/birthweight-hist-1.png", out.width="70%"}
...
```{r, fig.cap="Summary of disability status data from shared Databrary volumes; source: https://databrary.github.io/analytics/participant-demographics.html#n-participants-6"}
knitr::include_url("https://databrary.github.io/analytics/participant-demographics.html#n-participants-6")
```

#### Language {-}

https://databrary.github.io/analytics/participant-demographics.html#n-participants-3

### Pilot {-}

```{r, fig.cap="Variables related to a participant or session's 'pilot' status supported by Databrary's spreadsheet"}
knitr::include_graphics("include/img/databrary-ss-pilot.png")
```

### Exclusion {-}

```{r, fig.cap="Variables related to a participant or session's status as 'included' or 'excluded' from a final dataset supported by Databrary's spreadsheet"}
knitr::include_graphics("include/img/databrary-ss-exclusion.png")
```

### Task {-}

```{r, fig.cap="Variable(s) related to the task or tasks associated with a participant or session supported by Databrary's spreadsheet"}
knitr::include_graphics("include/img/databrary-ss-task.png")
```

### Condition {-}

```{r, fig.cap="Variable(s) related to an experimental condition associated with a participant or session supported by Databrary's spreadsheet"}
knitr::include_graphics("include/img/databrary-ss-condition.png")
```

### Group {-}

```{r, fig.cap="Variable(s) related to some grouping condition associated with a participant or session supported by Databrary's spreadsheet"}
knitr::include_graphics("include/img/databrary-ss-group.png")
```

### Context {-}

```{r, fig.cap="Variable(s) related to the context associated with a participant or session supported by Databrary's spreadsheet"}
...
The analytics report does not currently report data about the extent to which `setting` is reported.

## Tags and Keywords {-}

Databrary also supports attaching free-form tags and keywords to single participant datasets or entire volumes.

There are $n=410$ unique tags and keywords.
Here is a word cloud that depicts them:

```{r, fig.cap = "Most common tags and keywords across shared Databrary volumes; source: https://databrary.github.io/analytics/tags-and-keywords.html"}
